...
- [데이터 사이언스](posts/datascience/README.md)    
    ...
    - [머신러닝-지도학습](posts/datascience/machine-learning-supervised/README.md)
        ...
        - [결정론적 모형 & 생성모형](posts/datascience/machine-learning-supervised/discriminative-generative.md)
        - [기계학습 & 인공신경망 요약](posts/datascience/machine-learning-supervised/machine-learning.md)
    - [머신러닝-비지도학습](posts/datascience/machine-learning-unsupervised/README.md)
        ...
        - [가우시안 혼합 모형과 EM방법](posts/datascience/machine-learning-unsupervised/1801gmm.md)
    ...
    - [그래프 확률 모형](posts/datascience/probability-graph-model/README.md)
    ...
    - [딥러닝-신경망](posts/datascience/deeplearning-neuralnet/README.md)
        - [신경망](posts/datascience/deeplearning-neuralnet/01neuralnetwork.md)
        - [그레디언트 소멸 문제](posts/datascience/deeplearning-neuralnet/02gradient-vanishing.md)
        - [신경망 성능 개선 방법](posts/datascience/deeplearning-neuralnet/03neuralnetwork-performance.md)
        - [신경망 최적화 방법](posts/datascience/deeplearning-neuralnet/04neuralnetwork-optimization.md)
        - [그레디언트 최적화 알고리즘 요약](posts/datascience/deeplearning-neuralnet/gd-algorithem.md)
    - [딥러닝-이미지 분류 모형](posts/datascience/deeplearning-image-calssification/REAMDE.md)
