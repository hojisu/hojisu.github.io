...
- ANOVA는 3개 이상의 집단 간 평균을 검정할 때 사용하는 분석방법이다. 평균 차이를 비교하는데 분산의 개념을 활용한다. 집단의 평균들이 멀리 떨어져 전체 분산이 크면 클수록 집단간의 평균들이 서로 다른 모집단에서 발생했을 확률이 높습니다. **집단 평균들 간의 분산이 클수록, 집단 내 분산이 작을수록 서로 다른 모집단에서 발생했을 확률이 높습니다.**
