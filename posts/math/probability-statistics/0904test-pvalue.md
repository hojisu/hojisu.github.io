...
2. 활용 모수: 표본평균과 모 표준편차 혹은 표본 표준편차 값을 활용해
3. 분포 기반의 통계검정을 하는 것을 의미하며 표본의 갯수 및 분포 정보에 다라 서로 다른 검정을 수행하는 것을 의미합니다. 
...
검정이 귀무가설을 올바르게 기각하는 확률입니다. 대립가설이 사실일 때, 대립가설을 채택할 확률을 의미합니다. 즉 검정력이란 주장하고자 하는 대립가설이 채택될 확률이 됩니다. 검정력이 낮으면 효과를 찾지 못하여 효과가 없다는 잘못된 결론을 내릴 수 있습니다. 검정의 검정력이 너무 높으면 아주 작고 중요하지 않을 수 있는 효과가 유의하게 보일 수 있습니다. 
...
2. 표준편차가 클수록 검정력이 나빠집니다.
3. 두 모집단 간의 차이가 작을수록 검정력이 나빠집니다.
